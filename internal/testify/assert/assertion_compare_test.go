...
func TestGreater(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.helpers, "expr/internal/testify/assert.Greater")
	}
}
...
func TestGreaterOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "expr/internal/testify/assert.GreaterOrEqual")
	}
}
...
func TestLess(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "expr/internal/testify/assert.Less")
	}
}
...
func TestLessOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "expr/internal/testify/assert.LessOrEqual")
	}
}
...
func TestPositive(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "expr/internal/testify/assert.Positive")
	}
}
...
func TestNegative(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "expr/internal/testify/assert.Negative")
	}
}
